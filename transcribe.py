...
if torch.backends.mps.is_available():
    ...
    print(f"🖥  Device: CPU (wird langsam!)")
...
# ============================================================
# 2.2 – Test mit einer einzelnen Datei
# ============================================================
print("=" * 60)
...
# ============================================================
# 2.3 – Alle 1400 Dateien transkribieren
# ============================================================
print("=" * 60)
...
for i, row in sample.iterrows():
    ...
    if (i + 1) % 50 == 0 or (i + 1) == total:
        ...
        print(f"  [{i+1:4d}/{total}]  {elapsed:.0f}s vergangen | ~{remaining:.0f}s verbleibend")
